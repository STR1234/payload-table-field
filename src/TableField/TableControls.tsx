...
interface TableControlsProps {
  ...
  strings: Pick<
    TableFieldUIStrings,
    "addRow" | "columns" | "filters" | "searchPlaceholder"
  >;
  table: Table<any>;
  globalFilter: string;
  showColumns: boolean;
...
const getColumnLabel = (
  column: ReturnType<Table<any>["getAllLeafColumns"]>[number]
) => {
      ...
      <AnimateHeight duration={200} height={showColumns ? "auto" : 0}>
        <div className="payload-table-field__column-panel">
          {toggleableColumns.length > 0 ? (
            <div className="payload-table-field__column-visibility">
              {toggleableColumns.map((column) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="payload-table-field__pill-label">
